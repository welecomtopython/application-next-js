...
import { CardTitle, CardHeader, CardContent, Card, CardDescription } from "@/app/components/ui/card"
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <div className="grid gap-1">
                ...
                <CardDescription className="text-xs text-gray-500 dark:text-gray-400">John Doe</CardDescription>
              </div>
              <img
                alt="Avatar"
                className="rounded-full"
            ...
            <CardContent>
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">2022 Toyota Camry</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">License Plate</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">ABC123</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Recent Activity</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">2 trips this week</span>
                </div>
              </div>
            </CardContent>
          </Card>
